...
<!--STYLESHEET-->
    ...
    <script src="../js/reportes/load_chofer.js"></script>
    <script src="../js/reportes/make_reporte.js"></script>
</head>
                    ...
                    <div class="panel panel-bordered panel-primary">
                      ...
                      <div class="panel-body">
                        ...
                        <form id="create_reporte" method="post" class="form-horizontal form-label-left">                                                    
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periodo_interes">Estado Reparto <span class="required">*</span>
                            </label>

                              <div class="col-md-5 col-sm-5 col-xs-12">                        
                                <select id="periodo_interes" class="form-control" required>
