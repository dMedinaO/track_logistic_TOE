<?php
	...
	$query = "select chofer.nombre_chofer, AVG(reparto.paquetes_entregados) as entregados, AVG(reparto.paquetes_pendiente) as pendientes from reparto join reparto_chofer on (reparto.idreparto = reparto_chofer.reparto) join chofer on (chofer.idchofer = reparto_chofer.chofer) group by reparto_chofer.chofer order by entregados DESC, pendientes ASC limit 3";
