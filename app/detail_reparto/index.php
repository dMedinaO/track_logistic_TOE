...
<head>
    ...
    <script src="../js/detail_reparto/loadComuna.js"></script>
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="panel">
                      ...
                      <div class="col-sm-12 col-md-6 col-lg-6">
                        <h3 class="page-header text-overflow name_chofer"></h3>                                                                    
                      </div>

                      <div class="col-sm-12 col-md-6 col-lg-6">
                        <img id="image_stars" src="---" class="img-fluid" alt="Responsive image">                                                                    
                      </div>
                        

                      <div id="demo-custom-toolbar2" class="table-toolbar-left">
                          <button id="demo-dt-addrow-btn" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="demo-pli-plus"></i> Agregar Reparto</button>
                        </div>                      
                        ...
                        <table id="repartos_data" class="table table-striped table-bordered" cellspacing="0" width="100%">
                          <thead>
                            <tr>
                              ...
                              <th class="min-tablet">Paquetes Sobrantes</th>
                              <th class="min-tablet">Estado Pedido</th>
         ...
         <div class="modal-dialog">
           <div class="modal-content">
             <div class="modal-header">
               ...
               <h4 class="modal-title" id="myModalLabel">Agregar Nuevo Reparto</h4>
             </div>
             ...
             <form id="frmAgregar" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left">
               ...
               <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="paquetes_recogidos">Paquetes Recogidos <span class="required">*</span>
                 </label>

                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="paquetes_recogidos" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese número de paquetes recogidos">
                 </div>
               </div>  
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="paquetes_entregados" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese número de paquetes entregados">
                 </div>
               </div>                         
             ...
             <div class="modal-footer">
               <div class="form-group">
                 <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                   ...
                   <button type="button" id="agregar-pedido" class="btn btn-success" data-dismiss="modal">Aceptar</button>
