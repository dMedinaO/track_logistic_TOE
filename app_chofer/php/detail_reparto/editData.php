<?php
	...
	$query1 = "update reparto set paquetes_inicial = $paquetes_inicial, paquetes_pendiente=$pendientes, paquetes_entregados =$paquetes_entregados where idreparto = $idreparto";
